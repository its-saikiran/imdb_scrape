...
file_12p=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task13.json", 'r')
...
file_13=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task1.json", 'r')
...
for dic in task_14:
    ...
    print(dic)  
file_14=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task14.json", "w")
