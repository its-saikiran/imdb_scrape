...
file_=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task1.json", 'r')
file_2=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task4.json", 'r')
...
for movedic in file_task1:
    ...
    print(file_task4[s])  
    s+=1
anfile=open("/home/the-freak-coder/coder/python/Imdb_Scrape/Task13.json", 'w')
